...
export interface Product extends BaseEntity {
  images?: import("./admin-types").ProductImage[];
  brand?: string;
  modelNumber?: string;
...
export interface CompanySettings {
  support?: { customerEmail: string; customerPhone: string; installationEmail: string; technicalEmail: string };
  brand?: { roadlenzLogo: string; companyLogo: string };
  name: string;
...
export interface ContactMessage
  ...
  fleetSize?: string;
  enquiryType?: string;
  emailDelivery?: { status: "pending" | "sending" | "sent" | "failed"; attempts: number; lastAttemptAt?: string; sentAt?: string };
...
export interface AppUser {
  username?: string;
  adminRole?: import("./admin-types").AdminRole;
  active?: boolean;
  lastLoginAt?: string;
  internalNotes?: string;
  fleetSize?: string;
...
export interface CustomerQuote
  extends BaseEntity {
  quotationStatus?: import("./admin-types").QuotationStatus;
  pdfUrl?: string;
  kind: "customerQuote";
...
export interface Db {
  admin?: import("./admin-types").AdminStore;
  version: number;

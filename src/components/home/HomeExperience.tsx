        ...
        <Reveal className={styles.fleetCleanHeader}>
          <div>
            <span className={styles.eyebrow}>OUR FLEET</span>
              <h2>Powering Every Industry on the <em>Move.</em> </h2>
  ...
  return [
    {
      ...
      title: "GPS Tracking",
      features: ["GPS", "LIVE TRACKING", "REAL-TIME ALERTS", "CLOUD"],
    ...
    },
    {
      ...
      category: "AIS-140",
      title: "AIS-140 GPS",
      features: ["AIS-140", "GPS", "LIVE TRACKING", "COMPLIANCE"],
      href: "/products",
    ...
    },
    {
      ...
      category: "AI VIDEO",
      title: "AI Dashcams",
      features: ["AI VISION", "ADAS", "DMS", "4G"],
    ...
    },
    {
      ...
      title: "MDVR Systems",
      features: ["4G", "CLOUD", "LIVE VIDEO", "REMOTE PLAYBACK"],
    ...
    },
    {
      ...
      title: "Vehicle CCTV",
      features: ["HD CCTV", "360° VIEW", "NIGHT VISION", "RECORDING"],
    ...
    },
    {
      ...
      category: "AI SAFETY",
      title: "ADAS + DMS",
      features: ["ADAS", "DMS", "AI DETECTION", "DRIVER MONITORING"],
    ...
    },
    {
      ...
      features: ["FUEL SENSOR", "LIVE MONITORING", "ALERTS", "CLOUD"],
      href: "/products",
      ...
      <div className={styles.shell}>
        <Reveal className={styles.productReferenceHeader}>
          <div>
            ...
            <h2> Advanced Hardware for Smarter <em>Operations.</em> </h2>
          </div>
            ...
            {items.map((product, index) => (
              ...
              >
                ...
                <div className={styles.productReferenceCopy}>
                  <h3>{product.title}</h3>
                  <div className={styles.productReferenceFeatures}>
      ...
      <div className={styles.shell}>
        ...
        >
          ...
          >
            ...
            <h2>A Smarter, Connected <em>Fleet.</em></h2>
        ...
        <Reveal>
          ...
          >
            <div style={{ maxWidth: "760px" }}>
              ...
              <h2>Built for Fleets That Need Technology to <em> Work Every Day.</em></h2>
            ...
            >
              ...
              <motion.div
                ...
                style={{
                  ...
                  background:
                    "linear-gradient(145deg, #EAF6FF 0%, #D9EEFF 48%, #C8E7FF 100%)",
                  boxShadow: "0 18px 40px rgba(8, 120, 200, 0.12)",
                }}
              >
                ...
                <motion.div
                  ...
                  style={{
                    ...
                    border: "1px solid rgba(70, 164, 224, 0.24)",
                      ...
                      >
                        <i
                          ...
                          style={{
                            ...
                            borderRadius: "999px",
                            background: "#159BE8",
                            boxShadow: "0 0 10px rgba(21,155,232,.35)",
                          }}
                        />
                        {point}
                      </span>
              ...
              <motion.div
                ...
                style={{
                  ...
                  background:
                    "linear-gradient(135deg, #C9E9FF 0%, #A9D9F8 100%)",
                  border: "1px solid rgba(61, 155, 215, 0.28)",
                  boxShadow: "0 -6px 18px rgba(10, 132, 214, 0.08)",
                }}
              />
              ...
              <motion.div
                ...
                style={{
                  ...
                  background:
                    "linear-gradient(145deg, #DDF2FF 0%, #C5E7FA 58%, #B2DDF5 100%)",
                  boxShadow: "0 18px 36px rgba(4, 100, 160, 0.12)",
                }}
              >
                <motion.div
                  aria-hidden="true"
                ...
                >
                  <span
                    style={{
                      ...
                      border: "1px solid rgba(35, 125, 181, .18)",
                ...
                >
                  <strong
                    style={{
                      display: "block",
                      color: "#075B91",
                      fontSize: item.metric.length > 7 ? "19px" : "30px",
                      lineHeight: 1,
                      fontWeight: 850,
                      letterSpacing: "-0.035em",
                    }}
                  ...
                  <div
                    style={{
                      ...
                      marginTop: "14px",
                      paddingTop: "14px",
                      borderTop: "1px solid rgba(40, 122, 174, .16)",
                    }}
                  >
                    <span
                      style={{
                    ...
                    <motion.span
                      ...
                      style={{
                        ...
                        borderRadius: "50%",
                        color: "#075B91",
                        border: "1px solid rgba(35, 125, 181, .22)",
      ...
      <div className={styles.shell}>
        <div className={styles.intelligenceLayout}>
          <Reveal className={styles.intelligenceCopy}>
            ...
            <h2> Turn Fleet Data Into Actionable <em>Intelligence.</em></h2>
    ...
    <section className={`${styles.section} ${styles.softwareShowcaseSection}`}>
      ...
      <div className={styles.shell}>
        <Reveal className={styles.softwareShowcaseHeader}>
          ...
          <h2>One Platform. Every <em>Screen.</em></h2>
          <p style={HOME_SECTION_DESCRIPTION_STYLE}>
          ...
          >
            ...
            <div className={styles.softwareShowcaseCopy}>
              ...
              <div className={styles.softwareShowcaseFeatures}>
                ...
                <span className={styles.featureTitle}>Video Telematics</span>
                <span className={styles.featureTitle}>AI Safety</span>
                <span className={styles.featureTitle}>Fuel Intelligence</span>
                <span className={styles.featureTitle}>Smart Alerts</span>
                <span className={styles.featureTitle}>Reports & Analytics</span>
              </div>
      ...
      <div className={styles.shell}>
        <Reveal>
          <div style={{ maxWidth: "760px", marginBottom: "34px" }}>
            ...
            <h2>Chosen by Industry <em>Leaders.</em></h2>
      ...
      <div className={styles.shell}>
        <Reveal>
          <div style={{ maxWidth: "760px", marginBottom: "32px" }}>
            ...
            <h2> Where RoadLenz Keeps You <em>Moving.</em></h2>

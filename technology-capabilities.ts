 ...
 */
const media = (workspace: WorkspaceKind, alt: string): TechnologyMedia => ({ type: "placeholder", src: "", poster: "", workspace, alt });
...
export const technologySettings = {
  ...
  ctaTitle: "Ready to see your operation more clearly?",
  ctaDescription: "Bring your vehicles, your workflows and your questions. Explore the right setup for your operation.",
...
export function getTechnologyOverview(): TechnologyCapability {
  ...
  const steps = ["Locate", "See", "Understand", "Replay", "Improve", "Listen"];
  return {
    slug: "overview", name: "Technology", shortName: "Overview", published: true, order: 0, icon: "layers", theme: "light",
    heading: "From one live signal to a clearer operation.", description: "Live location, video and operational context, together. Explore the capabilities that connect the road to your next decision.",
    hero: media("fleet", "Connected fleet console software preview"), workspace: media("fleet", "Connected operational workspace preview"),
    workspaceTitle: "A live operation, connected.", workspaceDescription: "From the road to everyday decisions, bring the available signals into a clearer operational view.",
    outcomes: [], callouts: [],
